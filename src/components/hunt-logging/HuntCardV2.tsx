        ...
        <div className="mb-3 p-2 rounded-md border border-dark-teal/20 bg-dark-teal/5">
          <div className="flex items-center gap-4 text-xs">
            <div className="flex items-center gap-1 text-forest-shadow">
              {React.createElement(getIcon('clock'), { size: 12, className: 'text-dark-teal' })}
      ...
      <div className="mb-3 p-2 rounded-md border border-weathered-wood/20 bg-morning-mist">
        ...
        <div className="grid grid-cols-3 gap-2 text-xs">
          ...
          {tempContext.temperature !== null && (
            <div className="flex items-center gap-1 text-forest-shadow">
              {React.createElement(getIcon('thermometer'), { size: 12, className: 'text-burnt-orange' })}
          ...
          {hunt.wind_speed && (
            <div className="flex items-center gap-1 text-forest-shadow">
              {React.createElement(getIcon('wind'), { size: 12, className: 'text-dark-teal' })}
          ...
          {hunt.moon_phase !== null && (
            <div className="flex items-center gap-1 text-forest-shadow">
              {React.createElement(getIcon('moon'), { size: 12, className: 'text-muted-gold' })}
